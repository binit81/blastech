...
class EmployeeRoleController extends Controller
{
    ...
    {
        $home_navigations   =   home_navigation::where('company_id',Auth::user()->company_id)->with('home_navigations_data')->get();
    ...
    public function showPermissions(Request $request)
    {
        ...
        ->where('company_id',Auth::user()->company_id)->with('home_navigations_data')->whereNull('deleted_at')->with('home_navigations')->get();
    ...
    public function editPermissions(Request $request)
    {
        ...
        $roleName   =   employee_role::select('role_name')->where('company_id',Auth::user()->company_id)
        ->where('employee_role_id',$role_id)->whereNull('deleted_at')->get();

        $home_navigations   =   home_navigation::where('company_id',Auth::user()->company_id)->whereNull('deleted_at')->with('home_navigations_data')
    ...
    public function SaveRoletoEmployee(Request $request)
    {
        ...
        user::where('user_id',$employee_id)->where('company_id',$company_id)->update(array(
            'modified_by' => $userId,
            'employee_role_id' => $role_id
        ));
